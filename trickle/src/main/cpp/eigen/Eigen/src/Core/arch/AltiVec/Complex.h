...
//---------- float ----------
        struct Packet2cf {
            ...
            pmul(const Packet2cf &a, const Packet2cf &b) {
                Packet4f v1, v2;
                ...
                v2 = reinterpret_cast<Packet4f>(pxor(v2,
                                                     reinterpret_cast<Packet4f>(p4ui_CONJ_XOR)));
...
stride)
{
EIGEN_ALIGN16 std::complex<float>
af[2];
af[0] = from[0*stride];
af[1] = from[1*stride];
return
