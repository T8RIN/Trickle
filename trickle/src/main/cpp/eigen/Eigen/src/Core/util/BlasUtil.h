...
// forward declarations
        ...
        public:
            ...
            PacketType loadPacket(Index i) const {
            ...
            void storePacket(Index i, const PacketType &p) const {
...
// It always store each packet sequentially one `stride` apart.
        ...
        struct PacketBlockManagement {
            ...
            void store(Scalar *to, const Index stride, Index i, Index j,
...
// PacketBlockManagement specialization to take care of RowMajor order without ifs.
        ...
        public:
            ...
            PacketType loadPacket(Index i, Index j) const {
            ...
            *
            ...
            void storePacketBlock(Index i, Index j, const PacketBlock <SubPacket, n> &block) const {
...
// because some features makes less sense in this case.
        ...
        public:
            ...
            BlasLinearMapper(Scalar *data, Index incr) : m_data(data), m_incr(incr) {}
        ...
        public:
            ...
            blas_data_mapper(Scalar *data, Index stride, Index incr) : m_data(data),
                                                                       m_stride(stride),
                                                                       m_incr(incr) {}
            ...
            struct storePacketBlock_helper {
                ...
                void
                store(const blas_data_mapper<Scalar, Index, StorageOrder, AlignmentType, Incr> *sup,
            ...
            struct storePacketBlock_helper<SubPacket, ScalarT, n, -1> {
                ...
                void
                store(const blas_data_mapper<Scalar, Index, StorageOrder, AlignmentType, Incr> *,
 ...
 * and conjugate */
        ...
        struct blas_traits {
            ...
            extractScalarFactor(const XprType &) { return Scalar(1); }
        };
...
// pop scalar multiple
    ...
    extract(const XprType &x) { return Base::extract(x.rhs()); }

    static inline EIGEN_DEVICE_FUNC Scalar

    extractScalarFactor(const XprType &x) {
...
struct blas_traits<CwiseBinaryOp < scalar_product_op <
                   Scalar>, const CwiseNullaryOp <scalar_constant_op<Scalar>, Plain1>,
...
struct combine_scalar_factors_impl {
    ...
    static ResScalar run(const Lhs &lhs, const Rhs &rhs) {
    ...
    static ResScalar run(const ResScalar &alpha, const Lhs &lhs, const Rhs &rhs) {
...
struct combine_scalar_factors_impl<bool, Lhs, Rhs> {
    ...
    static bool run(const Lhs &lhs, const Rhs &rhs) {
        return blas_traits<Lhs>::extractScalarFactor(lhs) &&
               blas_traits<Rhs>::extractScalarFactor(rhs);
    }
    ...
    static bool run(const bool &alpha, const Lhs &lhs, const Rhs &rhs) {
        return alpha && blas_traits<Lhs>::extractScalarFactor(lhs) &&
               blas_traits<Rhs>::extractScalarFactor(rhs);
    }
};
...
ResScalar combine_scalar_factors(const ResScalar &alpha, const Lhs &lhs, const Rhs &rhs) {
...
ResScalar combine_scalar_factors(const Lhs &lhs, const Rhs &rhs) {
