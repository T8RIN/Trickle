...
/** \internal
  ...
  */
        ...
        struct functor_traits<scalar_sum_op<LhsScalar, RhsScalar> > {
            enum {
                Cost = (int(NumTraits<LhsScalar>::AddCost) + int(NumTraits<RhsScalar>::AddCost)) /
                       2, // rough estimate!
                PacketAccess =
                is_same<LhsScalar, RhsScalar>::value && packet_traits<LhsScalar>::HasAdd &&
        ...
        bool scalar_sum_op<bool, bool>::operator()(const bool &a, const bool &b) const {
            return a || b;
        }
...
/** \internal
  ...
  */
        ...
        bool scalar_product_op<bool, bool>::operator()(const bool &a, const bool &b) const {
            return a && b;
        }
...
/** \internal
  ...
  */
        ...
        struct scalar_cmp_op<LhsScalar, RhsScalar, cmp_UNORD>
            ...
            bool operator()(const LhsScalar &a, const RhsScalar &b) const {
                return !(a <= b || b <= a);
            }
        };
...
/** \internal
  ...
  */
        ...
        struct functor_traits<scalar_difference_op<LhsScalar, RhsScalar> > {
            enum {
                Cost =
                (int(NumTraits<LhsScalar>::AddCost) + int(NumTraits<RhsScalar>::AddCost)) / 2,
                PacketAccess =
                is_same<LhsScalar, RhsScalar>::value && packet_traits<LhsScalar>::HasSub &&
...
/** \internal
  ...
  */
        ...
        struct scalar_absolute_difference_op : binary_op_base<LhsScalar, RhsScalar> {
            ...
            const Packet
            packetOp(const Packet &a, const Packet &b) const { return internal::pabsdiff(a, b); }
        };
