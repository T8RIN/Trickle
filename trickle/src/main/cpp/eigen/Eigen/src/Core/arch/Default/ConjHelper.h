...
namespace Eigen {
    namespace internal {
        ...
        struct conj_if<true> {
            ...
            T operator()(const T &x) const { return numext::conj(x); }

            template<typename T>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE

            T pconj(const T &x) const { return internal::pconj(x); }
        };
        ...
        struct conj_if<false> {
            ...
            const T &pconj(const T &x) const { return x; }
        };
...
// Implementation with equal type, use packet operations.
        ...
        struct conj_helper<Packet, Packet, ConjLhs, ConjRhs> {
            ...
            Packet pmadd(const Packet &x, const Packet &y, const Packet &c) const {
            ...
            Packet pmul(const Packet &x, const Packet &y) const {
