    ...
    namespace internal {
        ...
        struct conservative_sparse_sparse_product_selector<Lhs, Rhs, ResultType, RowMajor, ColMajor, ColMajor> {
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res) {
                ...
                internal::conservative_sparse_sparse_product_impl<RowMajorRhs, Lhs, RowMajorRes>(
                        rhsRow, lhs, resRow);
                res = resRow;
            }
        };
        ...
        struct conservative_sparse_sparse_product_selector<Lhs, Rhs, ResultType, ColMajor, RowMajor, ColMajor> {
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res) {
                ...
                RowMajorRes resRow(lhs.rows(), rhs.cols());
                internal::conservative_sparse_sparse_product_impl<Rhs, RowMajorLhs, RowMajorRes>(
                        rhs, lhsRow, resRow);
                res = resRow;
            }
        };
        ...
        struct conservative_sparse_sparse_product_selector<Lhs, Rhs, ResultType, RowMajor, ColMajor, RowMajor> {
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res) {
                ...
                internal::conservative_sparse_sparse_product_impl<ColMajorLhs, Rhs, ColMajorRes>(
                        lhsCol, rhs, resCol);
                res = resCol;
            }
        };
        ...
        struct conservative_sparse_sparse_product_selector<Lhs, Rhs, ResultType, ColMajor, RowMajor, RowMajor> {
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res) {
                ...
                ColMajorRes resCol(lhs.rows(), rhs.cols());
                internal::conservative_sparse_sparse_product_impl<Lhs, ColMajorRhs, ColMajorRes>(
                        lhs, rhsCol, resCol);
                res = resCol;
            }
        };
    ...
    namespace internal {
        ...
        struct sparse_sparse_to_dense_product_selector<Lhs, Rhs, ResultType, RowMajor, ColMajor> {
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res) {
                typedef SparseMatrix<typename Lhs::Scalar, ColMajor, typename ResultType::StorageIndex> ColMajorLhs;
                ColMajorLhs lhsCol(lhs);
                internal::sparse_sparse_to_dense_product_impl<ColMajorLhs, Rhs, ResultType>(lhsCol,
                                                                                            rhs,
                                                                                            res);
            }
        };
        ...
        struct sparse_sparse_to_dense_product_selector<Lhs, Rhs, ResultType, ColMajor, RowMajor> {
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res) {
                typedef SparseMatrix<typename Rhs::Scalar, ColMajor, typename ResultType::StorageIndex> ColMajorRhs;
                ColMajorRhs rhsCol(rhs);
                internal::sparse_sparse_to_dense_product_impl<Lhs, ColMajorRhs, ResultType>(lhs,
                                                                                            rhsCol,
                                                                                            res);
            }
        };
