 ...
 ****************************************************************************/
    ...
    namespace numext {
        ...
        bessel_i0(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_i0, Scalar)
            ::run(x);
        }
        ...
        bessel_i0e(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_i0e, Scalar)
            ::run(x);
        }
        ...
        bessel_i1(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_i1, Scalar)
            ::run(x);
        }
        ...
        bessel_i1e(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_i1e, Scalar)
            ::run(x);
        }
        ...
        bessel_k0(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_k0, Scalar)
            ::run(x);
        }
        ...
        bessel_k0e(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_k0e, Scalar)
            ::run(x);
        }
        ...
        bessel_k1(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_k1, Scalar)
            ::run(x);
        }
        ...
        bessel_k1e(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_k1e, Scalar)
            ::run(x);
        }
        ...
        bessel_j0(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_j0, Scalar)
            ::run(x);
        }
        ...
        bessel_y0(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_y0, Scalar)
            ::run(x);
        }
        ...
        bessel_j1(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_j1, Scalar)
            ::run(x);
        }
        ...
        bessel_y1(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(bessel_y1, Scalar)
            ::run(x);
        }
