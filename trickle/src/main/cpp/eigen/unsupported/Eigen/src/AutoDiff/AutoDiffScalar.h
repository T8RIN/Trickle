...
//     }
        ...
        inline const AutoDiffScalar<EIGEN_EXPR_BINARYOP_SCALAR_RETURN_TYPE(DerType, Scalar,
                                                                           product)>
...
//   using Base::operator*=;
            ...
            AutoDiffScalar<DerivativeType> &
            derived() { return *static_cast<AutoDiffScalar<DerivativeType> *>(this); }
            ...
            friend inline const AutoDiffScalar<DerType &>
            operator+(const Real &a, const AutoDiffScalar<DerivativeType> &b) {
                return AutoDiffScalar<DerType &>(a + b.value(), b.derivatives());
            }
...
inline typename CleanedUpDerType<DerType>::type
...
EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(exp,
                                    using std::exp;
                                            ...
                                            return Eigen::MakeAutoDiffScalar(expx, x.derivatives() *
                                                                                   expx);)
...
EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(asin,
                                    using std::sqrt;
                                            using std::asin;
                                            return Eigen::MakeAutoDiffScalar(asin(x.value()),
                                                                             x.derivatives() *
                                                                             (Scalar(1) / sqrt(1 -
                                                                                               numext::abs2(
                                                                                                       x.value()))));)
...
EIGEN_AUTODIFF_DECLARE_GLOBAL_UNARY(tanh,
                                    using std::cosh;
                                            using std::tanh;
                                            return Eigen::MakeAutoDiffScalar(tanh(x.value()),
                                                                             x.derivatives() *
                                                                             (Scalar(1) /
                                                                              numext::abs2(
                                                                                      cosh(x.value()))));)
